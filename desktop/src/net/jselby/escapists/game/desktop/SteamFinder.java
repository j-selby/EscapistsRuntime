...
public class SteamFinder {
     ...
     */
    public static File getSteamPath(DesktopPlatformUtils platformUtils) {
        ...
        platformUtils.dialog("No Stream installation detected. Please locate The Escapists in the following prompt.");
        ...
        if (JFileChooser.APPROVE_OPTION == result) {
            ...
            if (escapistsTest.exists()) {
                ...
                platformUtils.showFatalMessageBox("Error", "Invalid directory (No TheEscapists.exe)");
                return null;
            }
        }
